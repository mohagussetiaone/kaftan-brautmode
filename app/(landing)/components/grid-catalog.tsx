      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-8">
        <div className="flex flex-col gap-20">
          <div className="flex flex-col gap-4">
            <h1 className="text-5xl font-playfair">Luxury designs,</h1>
            <h1 className="text-5xl font-playfair">without Luxury price</h1>
        ...
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-5xl font-playfair">Elegant gowns,</h1>
            <h1 className="text-5xl font-playfair">made effortless</h1>
