...
const BannerBody = () => {
  const t = useTranslations("LandingBannerTwo");
    ...
    >
      <div className="grid grid-cols-2 text-center h-full items-center mx-auto max-w-6xl px-4">
        ...
        <div className="flex flex-col justify-center items-center text-center whitespace-nowrap px-4 md:px-0">
          <p className="text-3xl md:text-5xl font-medium text-white mb-4 font-playfair">{t("title")}</p>
          <p className="text-3xl md:text-5xl font-medium text-white mb-4 font-playfair">{t("title_two")}</p>
